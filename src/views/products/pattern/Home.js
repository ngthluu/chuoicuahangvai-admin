...
const Home = () => {
  ...
  const handleDeleteSuccess = () => {
    fetchData()
    toast.success('Bạn đã xóa kiểu mẫu thành công')
  }
  ...
  return (
    <CRow>
      ...
      <Modal
        ...
        title="Xóa kiểu mẫu"
        content={`Bạn có muốn xóa kiểu mẫu ${deleteModalTargetName} không ?`}
        ...
        <CCard className="mb-4">
          <CCardBody>
            <div className="d-block d-md-flex justify-content-between">
              ...
              <Link to="/product-pattern/add">
                <CButton color="info" className="text-white w-100">
                  <FontAwesomeIcon icon={faPlus} /> <strong>Kiểu mẫu</strong>
                </CButton>
              </Link>
            </div>
          </CCardBody>
                    ...
                    <CTableRow key={item.id}>
                      ...
                      <CTableDataCell>
                        <CDropdown>
                          ...
                          <CDropdownMenu>
                            <CDropdownItem href={`/product-pattern/edit?id=${item.id}`}>
